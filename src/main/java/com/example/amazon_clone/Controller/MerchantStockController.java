...
//    @PostMapping("/{merchantId}/restock-request")
//    public ResponseEntity<String> requestRestock(@PathVariable int merchantId, @RequestBody MerchantStock request) {
//        String response = merchantStockService.requestRestock(merchantId, Integer.parseInt(request.getProductId()), request.getRequestedStock());
